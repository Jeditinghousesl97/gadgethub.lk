...
<head>
  ...
  <title><?= htmlspecialchars($title) ?> | GADGET HUB Admin</title>
...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-logo">
    <img src="<?= BASE_URL ?>images/logo.jpg" alt="GADGET HUB" class="sl-logo-img">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="<?= BASE_URL ?>admin/hero-slides.php" class="nav-item <?= $active==='hero-slides' ?'active':'' ?>">
      <i class="fas fa-images"></i><span>Hero Slides</span>
    </a>
    <a href="<?= BASE_URL ?>admin/promo-banners.php" class="nav-item <?= $active==='promo-banners' ?'active':'' ?>">
      <i class="fas fa-image"></i><span>Promo Banners</span>
    </a>
    <a href="<?= BASE_URL ?>admin/categories.php" class="nav-item <?= $active==='categories' ?'active':'' ?>">
      <i class="fas fa-tags"></i><span>Categories</span>
    </a>
    <a href="<?= BASE_URL ?>admin/brands.php" class="nav-item <?= $active==='brands' ?'active':'' ?>">
      <i class="fas fa-award"></i><span>Brands</span>
    </a>
    <a href="<?= BASE_URL ?>admin/delivery-rates.php" class="nav-item <?= $active==='delivery-rates' ?'active':'' ?>">
      <i class="fas fa-truck"></i><span>Delivery Fees</span>
    </a>
