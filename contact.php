...
<head>
  <?= renderSeoHead([
      'title' => 'Contact Us | Gadget Hub',
      'description' => 'Contact GADGET HUB for wholesale inquiries, product questions, support, and store directions in Sri Lanka.',
      ...
      <div class="contact-map-wrap" data-anim="right">
        <div class="contact-map">
          <iframe
            ...
            title="GADGET HUB Store Location">
          </iframe>
        </div>
        <?php if ($mapLink): ?>
