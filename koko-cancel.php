...
$status = strtoupper(trim((string)($_GET['status'] ?? 'CANCELED')));
...
$page = getPaymentPageConfig($paymentStatus, 'koko', 'cancel');

renderGatewayPaymentPage([
    'title' => $page['title'],
    'description' => 'KOKO payment cancellation status for your Gadget Hub order.',
    'canonical' => 'koko-cancel.php',
    'gateway' => 'KOKO',
    'tag' => $page['tag'],
