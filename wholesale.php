...
$waInquiryLink = 'https://wa.me/' . $phoneClean . '?text=' . rawurlencode("Hello GADGET HUB, I'm interested in wholesale pricing.");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <?= renderSeoHead([
      'title' => 'Wholesale | Gadget Hub',
      'description' => 'Wholesale computers, electronics, and accessories from GADGET HUB with competitive bulk pricing across Sri Lanka.',
      'canonical' => 'wholesale.php',
  ]) ?>
...
<section class="page-hero">
  ...
  <div class="container page-hero-inner">
    <div class="page-hero-text" data-anim="up">
      <span class="section-tag">For Businesses &amp; Dealers</span>
      <h1>Wholesale <em>Pricing</em></h1>
...
<!-- STATS BAR -->
<div class="stats-bar" data-anim="up">
  <div class="container">
    <div class="stats-grid">
      ...
      <div class="stat-item">
        <span class="stat-num">24<span class="stat-plus">h</span></span>
        <span class="stat-label">Quote Response Time</span>
      </div>
      <div class="stat-item">
        <span class="stat-num">100<span class="stat-plus">%</span></span>
        <span class="stat-label">Genuine Products</span>
      </div>
    </div>
  </div>
</div>

<!-- WHY WHOLESALE WITH GADGET HUB -->
<section class="section">
  <div class="container">
    <div class="section-header" data-anim="up">
      <span class="section-tag">Why Choose Us</span>
      <h2 class="section-title">Why Wholesale with <em>GADGET HUB?</em></h2>
      <p class="section-sub">We make bulk buying simple, reliable and cost-effective for businesses of all sizes.</p>
    </div>
    ...
    <div class="ws-benefits-grid">
      ...
      <div class="ws-benefit-card" data-anim="up" data-delay="3">
        ...
        <div class="ws-btxt">
          <h4>Fast Island-wide Delivery</h4>
...
<section class="section section-dark">
  <div class="container">
    <div class="section-header" data-anim="up">
      ...
      <p class="section-sub">Getting wholesale pricing from GADGET HUB is quick and straightforward.</p>
    </div>
    <div class="ws-steps">
...
<section class="section section-dark">
  <div class="container">
    <div class="section-header" data-anim="up">
      ...
      <h2 class="section-title">Order <em>Tiers</em></h2>
      <p class="section-sub">Bigger orders get better prices. Choose the tier that fits your business.</p>
    </div>
    ...
    <div class="ws-tiers-grid">
      ...
      <div class="ws-tier-card" data-anim="up" data-delay="1">
        ...
        <div class="ws-tier-moq">Minimum Order Value</div>
        <div class="ws-tier-price">Rs. 25,000 <small>/ order</small></div>
        <div class="ws-tier-divider"></div>
        <div class="ws-tier-features">
          <div class="ws-tier-feat"><i class="fas fa-check"></i> Wholesale pricing on all categories</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> 100% genuine products</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> Island-wide delivery</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> WhatsApp &amp; phone support</div>
          <div class="ws-tier-feat dim"><i class="fas fa-times"></i> Priority order processing</div>
          <div class="ws-tier-feat dim"><i class="fas fa-times"></i> Dedicated account manager</div>
        </div>
        <div class="ws-tier-btn">
          <a href="#ws-inquiry" class="btn btn-ghost" style="width:100%;justify-content:center">Get Started</a>
        </div>
      </div>
      ...
      <div class="ws-tier-card featured" data-anim="up" data-delay="2">
        ...
        <div class="ws-tier-moq">Minimum Order Value</div>
        <div class="ws-tier-price">Rs. 75,000 <small>/ order</small></div>
        <div class="ws-tier-divider"></div>
        <div class="ws-tier-features">
          <div class="ws-tier-feat"><i class="fas fa-check"></i> Better wholesale pricing</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> 100% genuine products</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> Priority island-wide delivery</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> WhatsApp, phone &amp; email support</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> Priority order processing</div>
          <div class="ws-tier-feat dim"><i class="fas fa-times"></i> Dedicated account manager</div>
        </div>
        <div class="ws-tier-btn">
          <a href="#ws-inquiry" class="btn btn-primary" style="width:100%;justify-content:center">Get a Quote</a>
        </div>
      </div>
      ...
      <div class="ws-tier-card" data-anim="up" data-delay="3">
        ...
        <div class="ws-tier-moq">Minimum Order Value</div>
        <div class="ws-tier-price">Rs. 150,000 <small>/ order</small></div>
        <div class="ws-tier-divider"></div>
        <div class="ws-tier-features">
          <div class="ws-tier-feat"><i class="fas fa-check"></i> Best wholesale pricing</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> 100% genuine products</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> Express island-wide delivery</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> Full multi-channel support</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> Priority order processing</div>
          <div class="ws-tier-feat"><i class="fas fa-check"></i> Dedicated account manager</div>
        </div>
        <div class="ws-tier-btn">
          <a href="#ws-inquiry" class="btn btn-ghost" style="width:100%;justify-content:center">Contact Us</a>
        </div>
      </div>
...
<!-- INQUIRY FORM -->
<section class="section" id="ws-inquiry">
  <div class="container">
    <div class="section-header" data-anim="up">
      <span class="section-tag">Get a Quote</span>
      <h2 class="section-title">Wholesale <em>Inquiry</em></h2>
      <p class="section-sub">Fill in your details and we'll get back to you with a price quote within 24 hours.</p>
    </div>

    <div class="ws-inquiry-wrap">

      <!-- Form -->
      <div class="contact-form-wrap" data-anim="up">
        <div class="cf-header">
          <h3 style="font-size:18px;font-weight:700;margin-bottom:6px">Submit Your Inquiry</h3>
          <p style="font-size:13px;color:var(--text-muted)">All fields marked <span class="cf-req">*</span> are required.</p>
        </div>

        <form class="contact-form" id="wsForm" novalidate>
          <div class="cf-row">
            <div class="cf-group">
              <label>Full Name <span class="cf-req">*</span></label>
              <div class="cf-input-wrap">
                <i class="fas fa-user"></i>
                <input type="text" placeholder="Your full name" id="wsName">
              </div>
            </div>
            <div class="cf-group">
              <label>Business / Shop Name <span class="cf-req">*</span></label>
              <div class="cf-input-wrap">
                <i class="fas fa-store"></i>
                <input type="text" placeholder="Your business name" id="wsBusiness">
              </div>
            </div>
          </div>
          ...
          <div class="cf-row">
            <div class="cf-group">
              ...
              <div class="cf-input-wrap">
                ...
                <input type="tel" placeholder="+94 77 xxx xxxx" id="wsPhone">
              </div>
            </div>
            <div class="cf-group">
              ...
              <div class="cf-input-wrap">
                ...
                <input type="email" placeholder="your@email.com" id="wsEmail">
              </div>
            </div>
          </div>
          ...
          <div class="cf-row">
            <div class="cf-group">
              <label>Product Category <span class="cf-req">*</span></label>
              <div class="cf-input-wrap">
            ...
            <div class="cf-group">
              <label>Estimated Quantity <span class="cf-req">*</span></label>
              <div class="cf-input-wrap">
          ...
          <div class="cf-group">
            <label>Product Details &amp; Message <span class="cf-req">*</span></label>
            <div class="cf-input-wrap cf-textarea-wrap">
              <i class="fas fa-comment-alt"></i>
              <textarea id="wsMessage" placeholder="Describe the products you need, specific models, brands, and any other requirements..."></textarea>
            </div>
          </div>

          <div class="cf-success" id="wsSuccess">
            <i class="fas fa-check-circle"></i>
            <span>Inquiry submitted! We'll contact you within 24 hours with a quote.</span>
          </div>

          <button type="submit" class="btn btn-primary cf-submit" id="wsSubmitBtn">
        ...
        <div class="ws-cs-card">
          ...
          <div style="display:flex;flex-direction:column;gap:12px">
            <div style="display:flex;align-items:center;gap:10px;font-size:13px;color:var(--text-muted)">
              ...
              <span>WhatsApp - within <strong style="color:var(--text)">1 hour</strong></span>
            </div>
            <div style="display:flex;align-items:center;gap:10px;font-size:13px;color:var(--text-muted)">
              <i class="fas fa-phone-alt" style="color:var(--primary);font-size:14px"></i>
              <span>Phone - immediate</span>
            </div>
            <div style="display:flex;align-items:center;gap:10px;font-size:13px;color:var(--text-muted)">
              <i class="fas fa-envelope" style="color:var(--primary);font-size:14px"></i>
              <span>Email / Form - within <strong style="color:var(--text)">24 hours</strong></span>
            </div>
          </div>
        </div>
    ...
    <div class="ws-faq" data-anim="up">
      <div class="ws-faq-item">
        <button class="ws-faq-q" type="button">
          ...
          <span class="ws-faq-ico"><i class="fas fa-chevron-down"></i></span>
        </button>
  ...
  <div class="container">
    <div class="brands-cta" data-anim="up">
      <div class="brands-cta-text">
        ...
        <h2 class="section-title" style="margin-bottom:8px">Start Your <em>Wholesale Journey</em></h2>
...
document.getElementById('wsForm').addEventListener('submit', function(e) {
  ...
  setTimeout(() => {
    ...
    document.getElementById('wsSuccess').classList.add('show');
    this.reset();
  }, 1400);
});
</script>
